-- Converge both possible histories of the former 20260727180000 collision.
-- Some databases may have recorded the generic-image enum migration under that
-- version instead of the domain-run finalizer. Never rewrite the recorded
-- history: replay the idempotent finalizer DDL under this fresh version.
