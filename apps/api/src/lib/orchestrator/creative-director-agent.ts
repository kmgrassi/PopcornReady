...
export const CREATIVE_DIRECTOR_SYSTEM_PROMPT = [
  ...
  "Call at most one offered root tool per turn. Delegate bounded Visuals or Audio execution when media work is needed; never attempt a leaf media/provider operation yourself. Do not recursively delegate or fabricate hidden workflow state.",
